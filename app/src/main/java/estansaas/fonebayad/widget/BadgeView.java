...
/**
 * Created by gerald.tayag on 10/8/2015.
 */
public class BadgeView extends TextView {
     ...
     *
     * @param context context for this view_payment_full.
     ...
     * Make the badge visible in the UI.
     *
     * @param anim Animation to apply to the view_payment_full when made visible.
     */
     ...
     * Make the badge non-visible in the UI.
     *
     * @param anim Animation to apply to the view_payment_full when made non-visible.
     */
     ...
     * Toggle the badge visibility in the UI.
     *
     * @param animIn Animation to apply to the view_payment_full when made visible.
     * @param animOut Animation to apply to the view_payment_full when made non-visible.
     */
